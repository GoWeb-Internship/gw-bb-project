...
const ModalRight = ({ bg, place }) => {
  ...
  return (
    <div className="overflow-y-scroll max-h-full py-[42px] px-[20px] w-[320px] h-full md:w-[458px] md:mx-auto lg:mx-0 lg:w-[934px] lg:h-[614px] lg:flex lg:justify-end lg:pt-[60px] lg:pr-[96px] lg:pb-[48px]">
      {pageFormat === 'desktop' ? (
        <Background2
