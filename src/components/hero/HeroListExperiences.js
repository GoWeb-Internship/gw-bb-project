...
const HeroListExperiences = ({ experience }) => {
  return (
    <div className="relative">
      <ul className="grid gap-y-6 md:border md:border-slate-50 md:rounded-2xl lg:py-7 relative md:py-5 md:pl-[46px] md:gap-y-8 md:grid-cols-2 lg:grid-cols-3 lg:divide-x">
