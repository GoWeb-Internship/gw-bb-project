...
const Story = ({
  ...
  return (
    <div className="w-full h-full overflow-y-auto px-[24px] pt-8 pb-[42px] border-2 border-slate-50 rounded-[20px]">
      ...
      <p
        ...
        className="transition-[max-height] font-medium text-bb1424 md:text-bb2024"
      >
